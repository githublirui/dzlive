   if (typeof console == "undefined") {    this.console = { log: function (msg) {  } };}
    ...
    function onSubmit() {
      ...
      var saystr = '{"type":"say","to_client_id":"'+to_client_id+'","to_client_name":"'+to_client_name+'","content":"'+input.value.replace(/"/g, '\\"').replace(/\n/g,'\\n').replace(/\r/g, '\\r')+'"}';
      console.log(saystr);
      ws.send(saystr);
      input.value = "";
      input.focus();
    ...
    function say(from_client_id, from_client_name, content, time){
        jQuery("#dialog").append('<div class="speech_item"><img src="http://lorempixel.com/38/38/?'+from_client_id+'" class="user_icon" /> '+from_client_name+' <br> '+time+'<div style="clear:both;"></div><p class="triangle-isosceles top">'+content+'</p> </div>');
    }
