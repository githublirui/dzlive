	...
	if(isPc){
		if(conf.rtmpUrl && conf.rtmpUrl != ''){
			...
			lssFunInterval = setInterval(function(){
				...
				var playerScript = 'http://v.weiya.tv/Public/Home/js/lssplay.js?v=2';//http://v.weiya.tv/Public/Home/js/lssplay.js?v=2;
			...
			hlsFunInterval = setInterval(function(){
				...
				var playerScript = 'http://v.weiya.tv/Public/Home/js/hlsplay.js?v=1';//http://v.weiya.tv/Public/Home/js/hlsplay.js?v=1;
				var layoutScript = document.createElement('script');
				layoutScript.type = 'text/javascript';
				layoutScript.charset = 'UTF-8';
				layoutScript.src = playerScript;
		...
		if(conf.hlsUrl && conf.hlsUrl != ''){
			...
			html5FunInterval = setInterval(function(){
				...
				var playerScript ='http://v.weiya.tv/Public/Home/js/htmlplay.js?v=3';//http://v.weiya.tv/Public/Home/js/htmlplay.js?v=3;
				var layoutScript = document.createElement('script');
				layoutScript.type = 'text/javascript';
				layoutScript.charset = 'UTF-8';
				layoutScript.src = playerScript;
