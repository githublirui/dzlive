...
+function($) {
    ...
    function isInRouterBlackList($link) {
        ...
        //tyq专用
        if($link.get(0).baseURI.match('WebContent') && $link[0].href && $link[0].href.indexOf('WebContent') <= 0 ){
            var tyq_href = $link[0].href;

          $link[0].href = $link[0].origin + '/WebContent' + $link[0].pathname + $link[0].search ;
