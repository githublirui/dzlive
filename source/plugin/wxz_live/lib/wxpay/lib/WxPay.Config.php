...
class WxPayConfig {
    ...
    public static function initConfig() {
        ...
        self::$mchid = $info['mchid'];
        self::$key = $info['password'];
        self::$appsecret = $info['secret'];
        self::$sslcert_path = "{$certPath}apiclient_cert.pem";
        self::$sslkey_path = "{$certPath}apiclient_key.pem";
        self::$isInit = true;
    }
